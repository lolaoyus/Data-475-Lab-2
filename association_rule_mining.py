...
print(f"{(length >1).sum()} itemise have more than 1 item") 
print(f"{(length >2).sum()} itemise have more than 2 item") 
print(f"{(length >3).sum()} itemise have more than 3 item") 
